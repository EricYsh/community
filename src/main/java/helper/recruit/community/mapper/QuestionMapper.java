...
public interface QuestionMapper {
    ...
    @Update("update question set title=#{title}, description=#{description}, gmt_modified=#{gmtModified}, tag=#{tag}, joblink=#{joblink}, company=#{company}, place=#{place} where id=#{id}")
